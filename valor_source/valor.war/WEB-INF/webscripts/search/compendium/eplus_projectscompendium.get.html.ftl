<h2>Erasmus+ and Former Programmes Projects Overview</h2>

<p>Here you can find an overview of projects funded by the European Commission under the Erasmus+ programme and it's predecessor programmes.</p>
...
<style>
	ul.erasmusPlusProjectsCompendiaList { margin:0; padding:2em 0; }
	ul.erasmusPlusProjectsCompendiaList li img { display:inline-block; vertical-align:middle; }
	ul.erasmusPlusProjectsCompendiaList li a { display:inline-block; vertical-align:baseline; }
	.lastUpdated { font-size:smaller; display:inline-block; vertical-align:baseline; }
</style>

<ul class="erasmusPlusProjectsCompendiaList">
