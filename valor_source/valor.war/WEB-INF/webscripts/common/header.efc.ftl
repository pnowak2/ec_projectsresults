<div class="lang-en" id="header">
    ...
    <p id="banner-title-text">${msg("links.europeanCommission")}<br>
        <span>${msg("links.efcWebsite")}</span> </p>
    ...
    <ul class="reset-list" id="accessibility-menu">
        <li class="m-hide"> <a href="${url.context}/europe-for-citizens/projects/">${msg("links.home")}</a> </li>
    ...
    <ul class="reset-list" id="services">
        ...
        <li> <a accesskey="5" href="${url.context}/europe-for-citizens/projects/">${msg("links.search")}</a> </li>
    </ul>
...
<div id="path">
    ...
    <ul class="reset-list">
        ...
        <li> <a href="${url.context}/europe-for-citizens/projects/">${msg("links.efcWebsite")}</a> </li>
        <li> <a href="${url.context}/europe-for-citizens/projects/">${msg("projects")}</a> </li>
