...
<script type="text/javascript" src="${url.context}/valor/js/linkify.min.js"></script>
<script type="text/javascript" src="${url.context}/valor/js/linkify-jquery.min.js"></script>
