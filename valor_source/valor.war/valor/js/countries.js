/**
 * Thx to https://github.com/psmithuk/iso-countries
 */
...
(function() {
  ...
  "VG": {
    ...
    "names": [
      ...
      "Islas VÃ­rgenes del Reino Unido"
    ],
    "region": "Americas",
    "subregion": "Caribbean",
    "currency": "USD",
...
resolveCountryCode = function(code){
    var country = iso.findCountryByCode(code);
    var imgs = YAHOO.util.Dom.getElementsByClassName(code.toLowerCase());
    for(var i=0; i<imgs.length; i++){
         imgs[i].title=country.name;
    }   
};